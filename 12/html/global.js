...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/1.png" width="1024" height="768" alt=""></div><div class="logo"><img src="slide1/2.png"></div>';
	break;
	case 2:
...
function open_page(url,page_id){
	...
	if(currentslide == 1){
	document.getElementById("click_through").innerHTML='<div id="buttons"><button name="button" style="opacity: 0.0;position:absolute; left:0px; top:0px; z-index:999; width:1024px; height:768px;"></button></div><div id="buttons"><button name="button" style="opacity: 0.0;position:absolute; left:240px; top:528px; z-index:9999; width:156px; height:207px;" value="OK" onclick="checkBtns(1)"></button></div>';
		}
